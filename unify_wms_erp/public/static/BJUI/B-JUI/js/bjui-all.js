...
+function ($) {
    ...
    var BJUI = {
        ...
        alertMsg: {displayPosition: 'middlecenter', alertTimeout: 10000,displayMode:'fade',mask:true}, //alertmsg display position && close timeout
        ajaxTimeout: 30000,
                ...
                if (options) {
                    ...
                    if (typeof options === 'object') {
                        ...
                        var addFile = function (file, isuploaded, _index) {
                            ...
                            var uploadedAttr = isuploaded && upunit === '张图片' ? ' style="cursor:pointer;" data-toggle="dialog" data-options="{id:\'bjui-dialog-view-upload-image\', html:\'<a href='+file.downsrc+'><img src='+file.src+'></a>\', width:800, height:500, mask:true, title:\'查看已上传图片\'}"' : '',
