<div class="bjui-pageContent">
    <form id="bookshipin-detail-form" action="/bookshipin/detailsubmit" class="datagrid-edit-form"
...
<!--             <label class="row-label">放行编号</label>

            <div id="release_nodiv" class="row-input">
                <input type="text" id="release_no" name="release_no" @if($type == 'sure') readonly
                       @endif value="{{$release_no}}">
            </div>

            <label class="row-label">报关单号</label>

            <div id="declarationdiv" class="row-input">
                <input type="text" id="declaration" name="declaration" @if($type == 'sure') readonly
                       @endif value="{{$declaration}}">
            </div> -->
            ...
            <label class="row-label">数量(吨)</label>
...
<script type="text/javascript">
    ...
    function saveBoshipDetail() {
        ...
        $('#bookshipin-detail-form').isValid(function (v) {
            if (v) {
                var data = $("#bookshipin-detail-form").serializeJson();
                ...
                if (handlestatus == 'add') {
                    ...
                    $('#bookshipin-detail-table').datagrid('reload', {data: allData});
                    BJUI.dialog('closeCurrent');
                }
                if (handlestatus == 'edit') {
                    $.CurrentNavtab.find('#bookshipin-detail-table').datagrid('updateRow', "{{$gridIndex}}", data);
