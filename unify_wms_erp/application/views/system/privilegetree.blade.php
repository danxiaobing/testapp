    ...
    <form data-toggle="ajaxsearch" data-options="{searchDatagrid:$.CurrentNavtab.find('#privilegelist-table')}">
        <fieldset>
            ...
            <div class="bjui-row col-4">
                ...
                <div class="row-input">
                    <select data-toggle="selectpicker" data-width="100%" name="bar_parentid" data-live-search="true" data-size="10">
...
<div class="bjui-pageContent clearfix">
    <table class="table table-bordered" id="privilegelist-table" data-toggle="datagrid" data-options="{
        ...
        editMode: {dialog:{width:'1000',height:'600',title:'权限管理',mask:true}},
