<div class="bjui-pageHeader " style="background-color:#fefefe; border-bottom:none;">
    <form data-toggle="ajaxsearch" data-options="{searchDatagrid:$.CurrentNavtab.find('#bookcarinlistreview-table')}">
        <fieldset>
...
<div class="bjui-pageContent clearfix">
    <table class="table table-bordered" id="bookcarinlistreview-table" height="40+50*{{count($list)}}" data-toggle="datagrid" data-options="{
            tableWidth:'100%',
            height: '100%',
            showToolbar: true,
            toolbarCustom: '#review_bookcarin_btn',
            addLocation: 'last',
            dataUrl: 'bookcarin/reviewJson',
            dataType: 'json',
            jsonPrefix: 'obj',
...
<div id="review_bookcarin_btn">
    <button type="button" class="btn btn-green" onclick="reviewbookcarin()" data-icon="gavel">审核</button>
</div>

<script>
    function reviewbookcarin() {
        var data = $('#bookcarinlistreview-table').data('selectedDatas');
        if(data == ''||data == null){
            ...
            BJUI.navtab({
                id: 'navab218',
                url: '/bookcarin/edit/mode/audit/id/' + data[0].sysno,
                type: 'post',
