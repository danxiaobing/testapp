<div class="bjui-pageContent">
    <form id="stockberthout-detail-form" action="" class="datagrid-edit-form" data-toggle="validate" data-data-type="json">
...
<script type="text/javascript">
    function saveBocarDetail() {
        ...
        $('#stockberthout-detail-form').isValid(function(v){
            if (v) {
                var data  = $("#stockberthout-detail-form").serializeJson();
                var allData  = $("#stockberthout-detail-table").data('allData');
                ...
                if (handlestatus == 'add') {
                    ...
                    $('#stockberthout-detail-table').datagrid('reload',  {data:allData});
                    BJUI.dialog('closeCurrent');
                }else if (handlestatus == 'edit') {
                    $.CurrentNavtab.find('#stockberthout-detail-table').datagrid('updateRow', "{{$gridIndex}}" , data);
                    var obj = $.CurrentNavtab.find('#stockberthout-detail-table').data('allData');
                    obj["{{$gridIndex}}"] = data;
                    $('#stockberthout-detail-table').datagrid('reload',  {data:obj});
                    BJUI.dialog('closeCurrent','');
                }
            }else{
                console.log('no');
