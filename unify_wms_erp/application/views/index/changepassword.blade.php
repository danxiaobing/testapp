...
<!--         <input type="hidden" name="user.username" value="${user.username }" id="j_userinfo_changepass_username">
        ...
        <div class="bjui-row col-1">
            ...
            <div class="row-input">
            <input type="text" name="username" value="{{$realname}}" readonly></div>
            <label class="row-label">登录账号:</label>
            <div class="row-input"><input type="text" name="usernames" value="{{$username}}" readonly></div>
...
<div class="bjui-pageFooter">
    <ul>
        <li><button type="submit" class="btn-green" data-icon="check">确认修改</button></li>
