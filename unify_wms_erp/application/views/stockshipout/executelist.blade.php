<div class="bjui-pageHeader">
    <form data-toggle="ajaxsearch" data-options="{searchDatagrid:$.CurrentNavtab.find('#ship-stockoutexecutelist-table')}">
        <fieldset>
            ...
            <div class="bjui-row col-4">
                ...
                <div class="row-input">
                    <input type="text" name="bar_no" id='shipexecute_bar_no' value="" placeholder="出库单号"></div>

                <label class="row-label">客户名称</label>
                <div class="row-input">
                    <input type="text" name="bar_name" id='shipexecute_bar_name' value="" placeholder="客户名称"></div>
                
                <label class="row-label">提货单号</label>
                <div class="row-input">
                    <input type="text" id='shipexecute_bar_receivenumber' name="bar_receivenumber" placeholder="提货单号">
                </div>

                <label class="row-label">货品名称</label>
                <div class="row-input">
                    <select name="bar_goodsname" id='shipexecute_bar_goodsname' data-size="5" data-toggle="selectpicker" data-live-search="true" data-width="100%">
...
<div class="bjui-pageContent clearfix">
    <table class="table table-bordered" id="ship-stockoutexecutelist-table" data-toggle="datagrid" data-options="{
        tableWidth:'100%',
        height: '100%',
        gridTitle : '',
        showToolbar: true,
        toolbarItem: '',
        toolbarCustom:'#ship_stockout_execute_tb',
        addLocation: 'last',
        dataUrl: '/stockout/shipExecuteListJson/bar_stockoutstatus/8/',
        dataType: 'json',
        paging: {pageSize:12},
...
<div id="ship_stockout_execute_tb">
    <button type="button" class="btn btn-green" data-icon="gavel"  id="ship_stockout_execute_edit_btn">编辑</button>
</div>

<script type="text/javascript">
        $("#ship_stockout_execute_edit_btn").click(function() {

            var data  = $("#ship-stockoutexecutelist-table").data('selectedDatas');
            if (data == '' || data == null) {
            ...
            BJUI.navtab({
                id: 'navtab0123',
                url: '/stockout/shipedit/type/execute/id/'+data[0].sysno,
                title: '船出库编辑'
            });    
        });
</script>