        ...
        <form action="{{$action}}" id="carcheck-edit-form" class="datagrid-edit-form"
            ...
            <div class="bjui-row col-2">
                    ...
                    <div class="bjui-row col-2">
                        ...
                        <div class="row-input required">
                            <select name="created_employeename" data-size="5"
                                    data-toggle="selectpicker" data-live-search="true" data-rule="required" data-width="100%" disabled>
                        ...
                        <div class="row-input required">
                            <input type="text" data-rule="required" name="audittime" value="@if($audittime && $audittime != '0000-00-00 00:00:00'){{date('Y-m-d H:i:s', strtotime($audittime))}}@else{{date('Y-m-d H:i:s')}}@endif" data-toggle="datepicker" data-rule="required;datetime" data-pattern="yyyy-MM-dd HH:mm:ss" readonly>
                        </div>
                        <label class="row-label">审核意见：</label>
                        <div class="row-input ">
                            <textarea name="auditreason" data-toggle="autoheight" cols="auto" rows="3" readonly>{{$auditreason or ''}}</textarea>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset class="customerfieldset">
                    ...
                    <input type="file" data-name="attachment[]" data-toggle="webuploader" disabled data-options="
                    {
                        pick: {label: '点击选择图片'},
